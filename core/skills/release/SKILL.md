...
3. Create `.workflows/current-state.md` with: workflow name, feature name, first phase (CHANGELOG) as ACTIVE, started/updated timestamps, empty Phase History table, empty Completed Steps, Artifacts, and Context sections.

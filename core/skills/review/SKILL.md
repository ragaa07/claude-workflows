...
|-------|--------|-----------|-------|
| FETCH | ACTIVE | <timestamp> | Starting PR data fetch |
...
Read `.claude/workflows.yml` and note relevant config for this workflow, especially `workflows.review.checklist` and `workflows.review.standards`.
